...
class Ship:
    ...
    """a Ship that stores information"""
    ...
    def get_coords(self) -> list:
        """returns the coordinates of the ship relative to the Board
    ...
    def in_boundary(self, sidelength=7) -> bool:
        """determines whether a Ship is in boundary

        Args:
            sidelength (int, optional): sidelength of Board. Defaults to 7.

        Returns:
            bool: whether or not it is in boundary
        """
